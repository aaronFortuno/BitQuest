...
import { Room, Transaction, Participant, CoinFile, SignedMessage, UTXO, UTXOTransaction, UTXOOutput, MempoolTransaction, NodeConnection, Block, HalvingInfo, EconomicStats, SimulationStats, ChallengeType, ChallengeData, MiningPool, BitcoinAddress, Phase9UTXO, Phase9MempoolTransaction } from '@/lib/types';
...
interface TeacherDashboardProps {
  ...
  phase9Addresses?: BitcoinAddress[];
  phase9Utxos?: Phase9UTXO[];
  phase9MempoolTxs?: Phase9MempoolTransaction[];
  onInitPhase9?: () => Promise<{ success: boolean; error?: string }>;
  onResetPhase9?: () => Promise<{ success: boolean; error?: string }>;
  onUpdatePhase9Settings?: (settings: { autoMineInterval?: number; autoMineCapacity?: number }) => Promise<{ success: boolean; error?: string }>;
  onFundAllPhase9Nodes?: () => Promise<{ success: boolean; funded?: number; error?: string }>;
  onGeneratePhase9Address?: () => Promise<{ success: boolean; address?: BitcoinAddress; error?: string }>;
  onCreatePhase9Transaction?: (
    inputUtxoIds: string[],
...
export default function TeacherDashboard({
  ...
  onInitPhase9,
  onResetPhase9,
  onUpdatePhase9Settings,
  onFundAllPhase9Nodes,
  onGeneratePhase9Address,
  onCreatePhase9Transaction,
  ...
  return (
    <div className="space-y-6">
      ...
      {currentPhase === 9 && (() => {
        ...
        // Teacher's own addresses and UTXOs
        ...
        // Mined blocks for blockchain viewer
        ...
        const handleP9CreateTransaction = async () => {
          ...
          const result = await onCreatePhase9Transaction?.(
            p9SelectedUtxoIds,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                ...
                <div className="zone-card">
                    ...
                    <div className="p-3 bg-surface-alt rounded-lg">
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          onChange={(e) => onUpdatePhase9Settings?.({ autoMineInterval: parseInt(e.target.value) })}
                    ...
                    <div className="p-3 bg-surface-alt rounded-lg">
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          onChange={(e) => onUpdatePhase9Settings?.({ autoMineCapacity: parseInt(e.target.value) })}
                          className="flex-1 accent-purple-500"
                        />
                  ...
                  <button
                    onClick={async () => {
                      const result = await onFundAllPhase9Nodes?.();
                      if (result?.success) {
                        setP9Feedback({
                          type: 'success',
                ...
                <div className="zone-card">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        onClick={() => onGeneratePhase9Address?.()}
