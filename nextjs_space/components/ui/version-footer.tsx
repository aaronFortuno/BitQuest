...
const CHANGELOG = [
  ...
  },
  {
    ...
    changes: {
      ca: [
        'Fase 5 completa: Xarxa de nodes amb visualització interactiva i mempool',
        'Topologia de xarxa amb drag & drop de nodes i connexions animades',
        'Propagació de transaccions en temps real amb polsos visuals entre nodes',
        'Radar de nodes orfes (desconnectats) amb reconnexió automàtica',
        'Desconnexió selectiva de nodes pel professor per demostrar particions de xarxa',
        'Panells de comparació de mempools al dashboard docent',
        'Fase 6: Proof of Work — Mineria i Blockchain',
        'Panell educatiu interactiu amb 4 seccions: mempool, hash explorer, mining amb nonce, cadena de blocs',
        'Hash explorer: entrada de text amb SHA-256 en temps real (Web Crypto API)',
        'Mining explorer: cerca de nonce amb dificultat configurable i zeros inicials',
        'Blockchain explorer: 3 blocs encadenats, editar un bloc invalida la cadena',
        'Bloc gènesi creat pel professor amb dificultat auto-calculada segons alumnes',
        'Cada alumne mina independentment: botó "Començar a minar", nonce, hash, anunciar bloc',
        'Visor de blockchain compartit (professor i alumne) amb blocs minats i bloc pendent animat',
        'Dashboard docent: visor blockchain amb botó gènesi, estadístiques de xarxa i rànking de miners',
        'Panell "Estat del node" per alumne: blocs minats, saldo BTC, intents de hash',
        'Botó "Reiniciar fase" del header ara també neteja blocs i stats de mineria (fase 6+)',
        'i18n complet (CA/ES/EN) per tots els panells educatius i interfícies de mineria',
      ],
      es: [
        'Fase 5 completa: Red de nodos con visualización interactiva y mempool',
        'Topología de red con drag & drop de nodos y conexiones animadas',
        'Propagación de transacciones en tiempo real con pulsos visuales entre nodos',
        'Radar de nodos huérfanos (desconectados) con reconexión automática',
        'Desconexión selectiva de nodos por el profesor para demostrar particiones de red',
        'Paneles de comparación de mempools en el dashboard docente',
        'Fase 6: Proof of Work — Minería y Blockchain',
        'Panel educativo interactivo con 4 secciones: mempool, hash explorer, mining con nonce, cadena de bloques',
        'Hash explorer: entrada de texto con SHA-256 en tiempo real (Web Crypto API)',
        'Mining explorer: búsqueda de nonce con dificultad configurable y ceros iniciales',
        'Blockchain explorer: 3 bloques encadenados, editar un bloque invalida la cadena',
        'Bloque génesis creado por el profesor con dificultad auto-calculada según alumnos',
        'Cada alumno mina independientemente: botón "Empezar a minar", nonce, hash, anunciar bloque',
        'Visor de blockchain compartido (profesor y alumno) con bloques minados y bloque pendiente animado',
        'Dashboard docente: visor blockchain con botón génesis, estadísticas de red y ranking de mineros',
        'Panel "Estado del nodo" por alumno: bloques minados, saldo BTC, intentos de hash',
        'Botón "Reiniciar fase" del header ahora también limpia bloques y stats de minería (fase 6+)',
        'i18n completo (CA/ES/EN) para todos los paneles educativos e interfaces de minería',
      ],
      en: [
        'Phase 5 complete: Node network with interactive visualization and mempool',
        'Network topology with drag & drop nodes and animated connections',
        'Real-time transaction propagation with visual pulses between nodes',
        'Orphan node radar (disconnected) with automatic reconnection',
        'Selective node disconnection by teacher to demonstrate network partitions',
        'Mempool comparison panels on teacher dashboard',
        'Phase 6: Proof of Work — Mining and Blockchain',
        'Interactive educational panel with 4 sections: mempool, hash explorer, mining with nonce, blockchain',
        'Hash explorer: text input with real-time SHA-256 (Web Crypto API)',
        'Mining explorer: nonce search with configurable difficulty and leading zeros',
        'Blockchain explorer: 3 linked blocks, editing a block invalidates the chain',
        'Genesis block created by teacher with auto-calculated difficulty based on students',
        'Each student mines independently: "Start mining" button, nonce, hash, announce block',
        'Shared blockchain viewer (teacher and student) with mined blocks and animated pending block',
        'Teacher dashboard: blockchain viewer with genesis button, network stats and miner ranking',
        '"Node status" panel per student: blocks mined, BTC balance, hash attempts',
        '"Reset phase" header button now also clears blocks and mining stats (phase 6+)',
        'Full i18n (CA/ES/EN) for all educational panels and mining interfaces',
      ],
    },
  },
  {
